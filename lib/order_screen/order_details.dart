...
import 'package:mycart/order_screen/componets/order_place_details.dart';
import 'package:mycart/order_screen/componets/order_status.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          orderPlaceDetails(
                            ...
                            detail2: "",
                            detail1:
                                "${data['orders'][index]['qty']} x ${data['orders'][index]['tprice']}",
                          ),
                          Padding(
